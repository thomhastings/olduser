As an intern admin for a Rocks cluster I was assigned to write a script to help clean out old users.
...
[hastint@rocks64 ~]$ python olduser.py -?
Old User Program v1.0
(c) Thom Hastings 2012
BSD License
designed for Rocks 5.2
